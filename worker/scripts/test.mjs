...
const entries = ['registration.test.mjs', 'media.test.mjs', 'rateLimit.test.mjs', 'adultAccounts.test.mjs', 'launch.test.mjs', 'review.test.mjs', 'adminContent.test.mjs', 'shop.test.mjs', 'maps.test.mjs', 'stock.test.mjs', 'communication.test.mjs'];
