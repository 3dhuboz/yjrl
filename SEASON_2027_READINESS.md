...
## Checkpoint — 9 September 2026, 06:35 UTC: private Nathan checklist deployed

- Objective completed: simple eight-item checklist, saved notes/status, private processed photo uploads and admin review handover; dedicated private access without a club admin account.
- Branch `codex/2027-signup-readiness`; pushed application source `6b244ca7d84dc78c6e39a04006c71978d7d407ae`. Changed files are listed in the preceding checkpoint; subsequent edits are release documentation only.
- Verification: 103 API/SQLite tests and Worker typecheck pass. Final review browser acceptance (`hs-20260909063101-2203664-fba27f7f`) verifies actual Images/R2 upload, saved notes/photos after reload, submission, admin pending-review import, public-photo denial, mobile layout and revocation. Production build (`hs-20260909063235-2208331-732f11e5`) and read-only live Chrome/API verification (`hs-20260909063420-2211653-5625fe08`) pass, including the real private link across Pages/API origins without login.
- Production migration 0014 applied (`hs-20260909063213-2207572-914aeadc`), after bookmark `000000e5-00000000-000050e1-14db8f86ac1fd1b24e39df86d3482a0c`. Worker `6d87bfb9-7267-4688-8b26-42e02a86abe3`; Pages https://399e98cc.yjrl.pages.dev; public bundle `index-CujK88dE.js`.
- One Nathan invite provisioned through hashed-only SQL (`hs-20260909063406-2211178-e3158e9d`), expires 8 December 2026. Raw link stays outside Git and is handed to Steve for sharing. Admins can revoke/create links under Website checklist. No production content, messages, email or payments were submitted by testing.
- Remaining limits: one shared preparation checklist; JPG/PNG/WebP photos up to 5 MB each and 20 per item; website notes/links only. Photos are not automatically approved or published. Existing registration/member/shop opening controls remain closed.
- Exact next action: Nathan supplies confirmed club information through the private checklist; admins review and transfer content into the appropriate website editor. Next independent launch engineering remains guardian verification/account recovery; do not treat checklist completion as legal or season-opening approval.
